...
//если оба видны, значит кнопка новое слово показывает
//если видно на русском, то по нажатию вылезает лейбл 2, который key
//надо придумать свитч или изучить второй экран
